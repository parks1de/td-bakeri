...
export const metadata: Metadata = {
  ...
  description: "Heimelaga brød og bakverk i Kaupanger. Bestill kake og utforsk menyen vår.",
  keywords: ["bakeri","kake","brød","Kaupanger","Sogndal","T&D Bakeri"],
  metadataBase: new URL("https://tdbakeri.no"),
  openGraph: { title: "T&D Bakeri", description: "Heimelaga brød og bakverk i Kaupanger.", images: ["/images/logo.png"] },
};
